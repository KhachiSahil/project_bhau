...
import { Home, FileText, CheckCircle, User, LogOut, Menu, Baby, ChartLine, X } from "lucide-react";
...
export default function EmployeeSideBar() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("toggle-employee-sidebar", handleToggle);
  }, []);
