...
export default function NewQueries({ onClose }: ButtonClick) {
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 p-4">
            {/* Modal Container */}
            <div className="bg-white shadow-lg rounded-lg p-6 w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden relative">
                {/* Close Button */}
                <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base sm:text-lg">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex gap-4">
                            <div className="flex flex-col">
                                <label>Kids</label>
                                <input type="number" placeholder="1" min={0} className="input-field w-full sm:w-32 border border-gray-500 rounded-lg p-2" />
                            </div>
                            <div className="flex flex-col">
                                <label>Adults</label>
                                <input type="number" placeholder="1" min={1} className="input-field w-full sm:w-32 border border-gray-500 rounded-lg p-2" />
                            </div>
                        </div>
                    </div>
